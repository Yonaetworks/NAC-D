...
"""fw_check.py: Firewall check for NACD."""
...
def fw_check(host, user, passwd):
    ...
    script = r"Get-CimInstance -Namespace root/SecurityCenter2 -ClassName FirewallProduct"
    ...
    fw_name = result1.group(1)
    fw_state = result2.group(1)
    fw_state = int(fw_state)
    ...
    return enable_state, signatures_state, fw_name
